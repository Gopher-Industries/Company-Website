        ...
        <s.ProductContainer>
            <s.ProductInnerContainer>
                ...
                <s.ProductContentRowGradient>
                    <s.ProductContentRowInner className="DetailsSection">
                        <s.ProductContentLeft className="ProductContentLeft">
                            <s.ProductTitle className="ProductTitle">
                                Product <br /> <span style={{ color: "white" }}>Overview</span>
                            </s.ProductTitle>
                            <s.ProductText style={{ color: "white" }} className="ProductDescription">
                        ...
                        <s.ProductContentRight className="rightSection">
                            <s.ProductVideo className="ProductVideo" src={ProductVideoSrc} controls={true} />
                ...
                <s.ProductContentRow>
                    <s.ProductContentRowInner className="DetailsSection">
                        <s.ProductContent>
                            <s.ProductTitle className="ProductTitle" style={{ color: "rgb(92, 118, 141)" }}>
                                Product <span style={{ color: "rgb(26, 180, 252)" }}>Features</span>
                            </s.ProductTitle>
                            <Carousel className="Carousel" NextIcon={<ArrowForwardIosIcon />} PrevIcon={<ArrowBackIosIcon />}>
                                {items.map((item) => {
                ...
                <s.ProductContentRow style={{ backgroundColor: "rgb(10,30,56)" }}>
                    <s.ProductContentRowInner style={{ width: '100%' }}>
                        <s.ProductContent className="ProductImagesContainer" style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                            <s.ProductTitle style={{ color: "white", paddingBottom: "50px" }} className="ProductImagesTitle">
                                Product Images
                            </s.ProductTitle>

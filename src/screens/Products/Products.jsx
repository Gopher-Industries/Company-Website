...
const Products = () => {
    return (
        <s.ProductContainer>
            <s.ProductVideo src={HomeVideo} width="100%" height='100vh%' controls={false} autoPlay={true} loop={true} muted={true}/>
            ...
            <Container style={{height: '100%'}}>
                ...
                <Row>
                    ...
                    <Col lg={4} md={6}>
                        <s.ProductLink href="/products/apollo"><ProductTile icon={<CollectionsBookmarkIcon />} title={"Apollo Database"} subtitle={"Standardised Patient Database"} /></s.ProductLink>
                    </Col>
                    <Col lg={4} md={6}>

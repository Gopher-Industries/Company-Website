...
const Home = () => {
    ...
    return (
        <s.HomeContainer>
            <s.HomeVideo>
                <video id="topVideo"src={HomeVideo} width="100%"controls={false} autoPlay={true} loop={true} muted={true}></video>
                <s.VideoOverlay initial={{y:"-300px", opacity:0}} animate={{y:0, opacity:1, transform:"translate(-50%,0)"}} transition={{duration:0.8, delay:0.3, ease: [0, 0.71, 0.2, 1.01]}}>
                    <s.VideoOverlayText id="VideoOverlayText">
            ...
            <s.HomeContentWide id={"home-page"}>
                <s.HomeCol>
                    <s.HomeTitleContainer>
                        <s.HomeTitle className="title-content" style={{color:"#1ab4fc"}}>GOPHER<br/>INDUSTRIES</s.HomeTitle>
                        <s.HomeTitle className="title-content"  style={{color:"#5c768d"}}>INNOVATING LIVES</s.HomeTitle>
                    </s.HomeTitleContainer>
                </s.HomeCol>
            ...
            <s.HomeContentWideImage2 id="TechStackContainer">
                <TechStackSection />
            </s.HomeContentWideImage2>
            <s.HomeContentWideGradient id={"about-us"}>
                <s.HomeCol className="HomeCol">
                    <s.HomeColAlign id="about-inner">
                ...
                <s.HomeCol className="HomeCol">
                    <s.AboutVideo  id="about-video" src={AboutVideo} controls={true} />
                </s.HomeCol>

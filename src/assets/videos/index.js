/**
 * Google App Engine has 32mb file restrictions for static content.
 * The below videos have been uploaded to projectx-videos Google Storage Bucket
 * and set to public access. The below dict holds the value of the public url.
 */
export const VIDEO_SRC = {
    ...
    "painassessment": "https://storage.googleapis.com/projectx-videos/painassessment.mp4",
}
